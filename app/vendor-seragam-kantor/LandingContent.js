...
import { CheckCircle2, MessageCircle, ArrowRight, Briefcase, Building, Award } from 'lucide-react';
import BreadcrumbSchema from '@/components/BreadcrumbSchema';

export default function LandingContent() {
  return (
    <div className="bg-white min-h-screen">
      <BreadcrumbSchema items={[{ name: "Beranda", path: "/" }, { name: "Vendor Seragam Kantor", path: "/vendor-seragam-kantor" }]} />
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-slate-900 px-6">
        <div className="absolute inset-0 z-0">
          <Image
            src="/port-corp.webp"
            alt="Vendor Seragam Kantor Bandung - Chima Konveksi"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            VENDOR <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-slate-500 italic">SERAGAM KANTOR</span> <br />
            BANDUNG.
          </motion.h1>
          <motion.p
          ...
          >
            Solusi produksi seragam korporat profesional. Spesialis pembuatan polo shirt, kemeja PDL, jaket seragam, dan perlengkapan corporate identity.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              Minta Penawaran <ArrowRight size={22} />
            </a>
            <Link
              href="/portfolio"
      ...
      <section className="py-16 md:py-56 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 md:mb-40">
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-blue-600 uppercase mb-8 block">Corporate Solutions</span>
            <h2 className="text-5xl md:text-8xl font-black text-slate-900 leading-[0.85] tracking-tighter">
              SERAGAM <br /> <span className="text-slate-400 italic">PROFESIONAL.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: Briefcase, title: "Polo Shirt", desc: "Bahan pique premium dengan bordir logo high-density. Tersedia berbagai varian warna korporat." },
              { icon: Building, title: "Kemeja PDL", desc: "Kemeja kerja lapangan dengan bahan drill oxford. Jahitan double untuk ketahanan maksimal." },
              { icon: Award, title: "Jaket Seragam", desc: "Jaket parka, jaket PDH, dan jaket almamater. Bahan water-resistant dengan bordir presisi." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-16 md:py-56 px-6 bg-slate-900 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-blue-500 uppercase mb-8 block">Corporate Standard</span>
            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tighter mb-16">
              KENAPA <br /> <span className="text-slate-600 italic">MEMILIH KAMI.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              "Bordir komputer high-density dengan setting presisi",
              "Bahan premium langsung dari supplier resmi",
              "QC 3 lapis untuk konsistensi kualitas",
              "Size grading profesional dari XS hingga 5XL",
              "Estimasi produksi jelas dan tepat waktu",
              "Garansi revisi jika hasil tidak sesuai spek",
              "Packing rapi siap distribusi ke banyak cabang",
              "Komunikasi intensif selama proses produksi",
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-16 md:py-64 px-6 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto bg-slate-900 rounded-[3rem] md:rounded-[5rem] p-8 md:p-32 text-center relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
          <div className="absolute inset-0 z-0 opacity-40">
            <Image src="/port-corp.webp" alt="" fill className="object-cover grayscale scale-110" />
          </div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-8xl font-black text-white mb-8 md:mb-12 leading-[0.9] tracking-tighter uppercase">
              PESAN <span className="text-slate-500 italic">SERAGAM</span> KANTOR.
            </h2>
            <p className="text-base md:text-3xl text-slate-400 mb-12 md:mb-20 font-medium leading-relaxed">
              Dapatkan penawaran harga terbaik untuk kebutuhan seragam perusahaan Anda.
            </p>
