...
import { CheckCircle2, MessageCircle, ArrowRight, Shirt, Printer, Package } from 'lucide-react';
import BreadcrumbSchema from '@/components/BreadcrumbSchema';

export default function LandingContent() {
  return (
    <div className="bg-white min-h-screen">
      <BreadcrumbSchema items={[{ name: "Beranda", path: "/" }, { name: "Produksi Kaos Custom", path: "/produksi-kaos-custom" }]} />
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-slate-900 px-6">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Produksi Kaos Custom Bandung - Chima Konveksi"
            fill
            priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            PRODUKSI <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-slate-500 italic">KAOS CUSTOM</span> <br />
            BANDUNG.
          </motion.h1>
          <motion.p
          ...
          >
            Vendor produksi kaos custom profesional untuk brand distro, merchandise event, dan seragam perusahaan dengan standar kualitas premium.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 md:py-56 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24 md:mb-40">
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-blue-600 uppercase mb-8 block">Our Expertise</span>
            <h2 className="text-5xl md:text-8xl font-black text-slate-900 leading-[0.85] tracking-tighter">
              SPESIALIS <br /> <span className="text-slate-400 italic">KAOS CUSTOM.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: Shirt, title: "Bahan Premium", desc: "Cotton Combed 20s-30s, Carded, CVC, PE. Semua bahan grade A dengan rajutan rapat dan nyaman dipakai." },
              { icon: Printer, title: "Sablon Berkualitas", desc: "Plastisol, Rubber Ink, DTF, Gliter, Foil. Tim sablur profesional dengan pengalaman belasan tahun." },
              { icon: Package, title: "Finishing Rapi", desc: "Packing standar ekspor, label woven custom, hangtag, dan quality control 3 lapis sebelum dikirim." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-16 md:py-56 px-6 bg-slate-900 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl">
            <span className="text-[10px] md:text-xs font-black tracking-[0.5em] text-blue-500 uppercase mb-8 block">Kenapa Pilih Kami</span>
            <h2 className="text-5xl md:text-8xl font-black text-white leading-[0.85] tracking-tighter mb-16">
              KEUNGGULAN <br /> <span className="text-slate-600 italic">PRODUKSI KAOS.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              "MOQ mulai 24 pcs — cocok untuk brand pemula",
              "Bahan grade A langsung dari pabrik tekstil",
              "QC 3 lapis: potong, jahit, finishing",
              "Sablon presisi dengan mesin modern",
              "Estimasi produksi 14-21 hari kerja",
              "Garansi revisi jika tidak sesuai spek",
        ...
        <div className="max-w-7xl mx-auto bg-slate-900 rounded-[3rem] md:rounded-[5rem] p-8 md:p-32 text-center relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-8xl font-black text-white mb-8 md:mb-12 leading-[0.9] tracking-tighter uppercase">
              MULAI <span className="text-slate-500 italic">PRODUKSI</span> KAOS ANDA.
            </h2>
            <p className="text-base md:text-3xl text-slate-400 mb-12 md:mb-20 font-medium leading-relaxed">
              Konsultasikan desain kaos Anda bersama tim produksi kami.
            </p>
